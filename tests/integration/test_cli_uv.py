...
lockfiles = glob(join(INFILES_DIRECTORY, 'uv', '*', 'uv.lock'))
...
@ddt
class TestCliUv(TestCase, SnapshotMixin):

    def test_help(self) -> None:
        res, out, err = run_cli('uv', '--help')

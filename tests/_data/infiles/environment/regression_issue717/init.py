...
def main() -> None:
    ...
    pip_install(
        # https://github.com/CycloneDX/cyclonedx-python/issues/717
        'celery==5.1.2'
    )

    """ Attention: running with pip 24.0 will warn:
    DEPRECATION: celery 5.1.2 has a non-standard dependency specifier pytz>dev.
    pip 24.1 will enforce this behaviour change.
    A possible replacement is to upgrade to a newer version of celery or contact the author to suggest that they

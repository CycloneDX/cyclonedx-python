...
make-bom: Generate a CycloneDX BOM
====================================================

Use the ``make-bom`` subcommand to generate a BOM given your defined inputs.
...
.. code-block:: bash
    ...
    cyclonedx-py make-bom -p -i PATH/TO/poetry.lock -o sbom.xml
...
.. code-block:: bash
    ...
    cyclonedx-py make-bom -p -o sbom.xml
...
.. code-block:: bash
    ...
    cyclonedx-py make-bom -pip -i PATH/TO/Pipfile.lock -o sbom.xml
...
.. code-block:: bash
    ...
    cyclonedx-py make-bom -pip -o sbom.xml
...
.. code-block:: bash
    ...
    cyclonedx-py make-bom -r -i PATH/TO/requirements.txt -o sbom.xml

If your ``requirements.txt`` is in the current working directory, you can also shorten this to:

.. code-block:: bash

    cyclonedx-py make-bom -r -o sbom.xml
